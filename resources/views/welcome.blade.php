...
<body class="bg-white text-gray-600 work-sans leading-normal text-base tracking-normal">
    ...
    <main class="relative min-h-screen1 flex flex-col justify-center bg-slate-900 overflow-hidden">
        <div class="w-full max-w-6xl mx-auto px-4 md:px-6 py-24">
            <div class="text-center">
                ...
                <div
                    ...
                    Trusted by the most innovative minds in <span
    ...
    <section class="bg-white py-8">
        ...
        <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
            ...
            {{-- <section id="Projects"
                ...
                <div class="w-96 bg-gray-400 shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
                    <a href="#">
                        <img src="https://images.unsplash.com/photo-1646753522408-077ef9839300?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwcm9maWxlLXBhZ2V8NjZ8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
                            alt="Product" class="h-90 w-full object-cover rounded-t-xl bg-slate-300" />
